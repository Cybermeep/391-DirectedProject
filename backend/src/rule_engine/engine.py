...
from .detectors import (
    ...
    ICMPSmurfDetector,
    ICMPTimestampProbeDetector,
    ICMPUnreachableFloodDetector,
    IPFragmentationFloodDetector,
    MACSpoofingDetector,
    MalformedPacketFloodDetector,
    NullScanDetector,
    PingSweepDetector,
    PortScanDetector,
    RSTFloodDetector,
...
_DETECTOR_REGISTRY: Dict[str, type] = {
    ...
    'RULE-014': SYNFINScanDetector,
    'RULE-015': ACKScanDetector,
    'RULE-016': ICMPSmurfDetector,
    'RULE-017': ICMPRedirectDetector,
    'RULE-018': DNSQueryFloodDetector,
    'RULE-019': DNSAnyQueryDetector,
    'RULE-020': MACSpoofingDetector,
    'RULE-021': BruteForceDetector,
    'RULE-022': BruteForceDetector,
    'RULE-023': BruteForceDetector,
    'RULE-024': RSTFloodDetector,
    'RULE-025': IPFragmentationFloodDetector,
    'RULE-026': TCPZeroWindowDetector,
    'RULE-027': DNSTunnelingDetector,
    'RULE-028': MalformedPacketFloodDetector,
    'RULE-029': ICMPTimestampProbeDetector,
    'RULE-030': ICMPUnreachableFloodDetector,
}
